	...
	private String generateMoviesTable(JsonObject movies) {
		...
		for(JsonElement movieElem : movieArr) {
			...
			cardStr += "<div class='col'>"
					...
					+ "<input name='movieupdate' id='movieupdate' type='button' value='Update' class='btn btn-sm btn-secondary w-100' data-thumb='"+ thumbnailData +"' data-movieid='" + movie.get("movieid").getAsString() + "'></td>"
